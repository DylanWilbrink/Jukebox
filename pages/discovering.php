...
<head>
    <?php
    include '../php/discover.php';
    include '../includes/links.php';
    ?>
    <link rel="stylesheet" href="../includes/headerStyle.css">
    <link rel="stylesheet" href="../includes/footerStyle.css">
    <link rel="stylesheet" href="../style/discoverStyle.css">
</head>
<body>
...
<div id="searchBarWrapper">
    <div id="searchBar">
        <form action="discovering.php" method="post">
...
<!--    Display all songs-->
    <div id="content">
        <?php foreach ($shows as $result) { ?>
            ...
            <div onclick="window.location='/Jukebox/pages/song.php?song=<?php echo $result['song_id']; ?>'" class="song"
