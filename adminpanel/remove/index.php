...
<div style="width: 100%; height: auto; overflow-x: scroll;">
        <table id="contentTable">
            ...
            <?php foreach ($results as $result) { ?>
                <tr class="userRow" onclick="window.location='http://localhost/Jukebox/song/song.php?song=<?php echo $result['song_id']; ?>'">
                    <td>
                    ...
                    <td>
                        <a class="userLink" href="delete.php?id=<?php echo $result['song_id']; ?>">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
