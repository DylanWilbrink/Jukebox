...
<div id="comments">
    ...
    <?php foreach ($mute_results as $mute_result) {
        if ($mute_result['punishment'] == 1) {
            ...
            ?>
            <form action="../comments/commenting.php?id=<?php echo $_GET['song']; ?>" method="post">
    ...
    <?php foreach ($comments as $comment) { ?>
        <div id="comment-content">
            <div id="comment-rating">
                ...
                <a class="link"
                   href="../profile/profile.php?id=<?php echo $comment['user_id'] ?>"><?php echo $functions->getUsername($comment['user_id']); ?></a><br>
