...
<div id="content">
    <div id="head">
        ...
        <span id="text">
            ...
            <?php echo $result['first_name'] . ' ' . $result['surname']; ?> <sup><a class="link"
                                                                                    href="../report/report.php?id=<?php echo $_GET['id']; ?>">Report</a></sup>
            <br><br>
        <div class="tag">
    ...
    <?php if ($_GET['id'] == $_SESSION['user_id']) { ?>
        <a class="link" href="editprofile/editprofile.php?id=<?php echo $_GET['id'] ?>">Edit profile</a>
    <?php } ?>
</div>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <?php foreach ($song_results as $song) { ?>
                    <div onclick="window.location='http://localhost/Jukebox/song/song.php?song=<?php echo $song['song_id']; ?>'"
                         class="swiper-slide"
